                    ...
                    <div className="hidden md:flex items-center gap-8 text-sm font-medium tracking-wide text-stone-600">
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute top-full left-0 mt-0 w-48 bg-white border border-stone-200 shadow-xl rounded-sm py-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 translate-y-2 group-hover:translate-y-0">
                                ...
                                <a href="#" onClick={handleProductClick} className="block px-4 py-3 text-sm text-stone-600 hover:bg-stone-100 hover:text-stone-900 transition-colors border-b border-stone-100 last:border-0 text-left">EulerOS</a>
                                <a href="#" onClick={handleProductClick} className="block px-4 py-3 text-sm text-stone-600 hover:bg-stone-100 hover:text-stone-900 transition-colors text-left">PIL-VAE M1</a>
                            </div>
                        </div>
            ...
            {menuOpen && (
                <div className="fixed inset-0 z-40 bg-[#F9F8F4] flex flex-col items-center justify-center gap-6 text-xl font-serif animate-fade-in">
                    <div className="flex flex-col items-center gap-4 pb-4 border-b border-stone-300 w-48">
                        ...
                        <a href="#" onClick={handleProductClick} className="hover:text-stone-900 transition-colors cursor-pointer">EulerOS</a>
                        <a href="#" onClick={handleProductClick} className="hover:text-stone-900 transition-colors cursor-pointer">PIL-VAE M1</a>
                    </div>
